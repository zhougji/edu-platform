...
declare const __VLS_component: import("vue").DefineComponent<{
    ...
    check: (data: import("element-plus/es/element-plus").TreeNodeData, checkedInfo: import("./types").CheckedInfo) => void;
    "current-change": (data: import("element-plus/es/element-plus").TreeNodeData, node: import("./types").TreeNode) => void;
    "node-expand": (data: import("element-plus/es/element-plus").TreeNodeData, node: import("./types").TreeNode) => void;
    "check-change": (data: import("element-plus/es/element-plus").TreeNodeData, checked: boolean) => void;
    "node-click": (data: import("element-plus/es/element-plus").TreeNodeData, node: import("./types").TreeNode, e: MouseEvent) => void;
    "node-contextmenu": (evt: Event, data: import("element-plus/es/element-plus").TreeNodeData, node: import("./types").TreeNode) => void;
    "node-collapse": (data: import("element-plus/es/element-plus").TreeNodeData, node: import("./types").TreeNode) => void;
    "node-drop": (data: import("element-plus/es/element-plus").TreeNodeData, node: import("./types").TreeNode, e: DragEvent) => void;
    ...
    "onCurrent-change"?: ((data: import("element-plus/es/element-plus").TreeNodeData, node: import("./types").TreeNode) => any) | undefined;
    "onNode-expand"?: ((data: import("element-plus/es/element-plus").TreeNodeData, node: import("./types").TreeNode) => any) | undefined;
    onCheck?: ((data: import("element-plus/es/element-plus").TreeNodeData, checkedInfo: import("./types").CheckedInfo) => any) | undefined;
    "onCheck-change"?: ((data: import("element-plus/es/element-plus").TreeNodeData, checked: boolean) => any) | undefined;
    "onNode-click"?: ((data: import("element-plus/es/element-plus").TreeNodeData, node: import("./types").TreeNode, e: MouseEvent) => any) | undefined;
    "onNode-contextmenu"?: ((evt: Event, data: import("element-plus/es/element-plus").TreeNodeData, node: import("./types").TreeNode) => any) | undefined;
    "onNode-collapse"?: ((data: import("element-plus/es/element-plus").TreeNodeData, node: import("./types").TreeNode) => any) | undefined;
    "onNode-drop"?: ((data: import("element-plus/es/element-plus").TreeNodeData, node: import("./types").TreeNode, e: DragEvent) => any) | undefined;
}, {
